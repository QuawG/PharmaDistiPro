...
import DeleteConfirmation from "./DeleteConfirmation"; // Adjust the import path as necessary
...
export default function AddPurchaseOrder() {
    ...
    const confirmDeleteProduct = () => {
        if (productToDelete !== null) {
            setSelectedProducts(prev => prev.filter(product => product.id !== productToDelete));
