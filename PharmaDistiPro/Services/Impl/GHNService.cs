...
namespace PharmaDistiPro.Services.Impl
{
    public class GHNService : IGHNService
    {
        ...
        public async Task<Response<CreateOrderResponse>> CreateOrder(int? orderId)
        {
            ...
            // Customer info
            orderRequest.ToName = "Ngo Huu Loc";
            orderRequest.ToPhone = "0987654321";
            orderRequest.ToAddress = "So 1 Dai Co Viet, Hai Ba Trung, Ha Noi";
            orderRequest.ToDistrictId = 1482;
            orderRequest.ToWardCode = "11010";
            orderRequest.ClientOrderCode = "ORDERCODE2";
            orderRequest.Coupon = "";
            // order info
