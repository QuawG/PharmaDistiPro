...
namespace PharmaDistiPro.Services.Impl
{
    public class ProductLotService : IProductLotService
    {
        ...
        public async Task<Response<ProductLotResponse>> CreateProductLot(ProductLotRequest productLot)
        {
            ...
            ProductLot createdProductLot = await _productLotRepository.CreateProductLot(newProductLot);
            if (createdProductLot == null)
            {
                response = new Response<ProductLotResponse>
                {
                    StatusCode = 500,
        ...
        public async Task<Response<ProductLotResponse>> UpdateProductLot(ProductLotRequest ProductLot)
        {
            ...
            OldProductLot.Quantity = ProductLot.Quantity;
